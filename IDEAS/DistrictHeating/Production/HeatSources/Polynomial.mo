...
equation
  ...
  QMax = Poly2ndDegree3Inputs(beta=beta, powers=powers, X=100, Y=m_flowHx_scaled*kgps2lph, Z=THxIn-273.15)/etaRef*QNom;
  ...
  //Polynomial
  eta = Poly2ndDegree3Inputs(beta=beta, powers=powers, X=modulation, Y=m_flowHx_scaled*kgps2lph, Z=THxIn-273.15);
