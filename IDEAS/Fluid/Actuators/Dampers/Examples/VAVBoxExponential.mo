...
model VAVBoxExponential
 ...
 package Medium = IDEAS.Media.Air;
  ...
  IDEAS.Fluid.Actuators.Dampers.Exponential dam(
  ...
  IDEAS.Fluid.Actuators.Dampers.VAVBoxExponential vav(
...
equation
 ...
 annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,
            -100},{100,100}}),
                     graphics),
             __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Actuators/Dampers/Examples/VAVBoxExponential.mos"
        "Simulate and plot"),
