...
model MixingBox
 ...
 package Medium = IDEAS.Media.Air "Medium in the component"
  ...
  Dampers.MixingBox mixBox(
    ...
    IDEAS.Fluid.Sources.Boundary_pT bouSup(             redeclare package
      Medium = Medium, T=273.15 + 26,
    use_p_in=true,
    nPorts=1)                                                                       annotation (Placement(
        transformation(extent={{68,-10},{48,10}}, rotation=0)));
    IDEAS.Fluid.Sources.Boundary_pT bouRet(             redeclare package
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,
            -100},{100,100}})),
             __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Actuators/Dampers/Examples/MixingBox.mos"
        "Simulate and plot"),
