...
model ValveParameterization
 ...
 package Medium = IDEAS.Media.Water.Simple;
  ...
  IDEAS.Utilities.Diagnostics.AssertEquality equ1(threShold=0.01)
    annotation (Placement(transformation(extent={{80,60},{100,80}})));
  IDEAS.Utilities.Diagnostics.AssertEquality equ2(threShold=0.01)
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Actuators/Valves/Examples/ValveParameterization.mos"
        "Simulate and plot"),
