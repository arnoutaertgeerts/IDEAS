...
model FlowMachineFeedbackControl "Flow machine with feedback control"
  ...
  IDEAS.Fluid.FixedResistances.FixedResistanceDpM dp2(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dp_nominal=dp_nominal/2) "Pressure drop"
    annotation (Placement(transformation(extent={{80,40},{100,60}})));
  IDEAS.Fluid.Movers.FlowMachine_y fan(
      redeclare package Medium = Medium,
...
First implementation.
    ...
    __Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Movers/Examples/FlowMachineFeedbackControl.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600,
      Tolerance=1e-06));
