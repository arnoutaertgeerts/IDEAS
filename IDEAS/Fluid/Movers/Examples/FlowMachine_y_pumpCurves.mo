...
model FlowMachine_y_pumpCurves
  ...
  parameter Modelica.SIunits.Pressure dp_nominal = 10000 "Nominal pressure";
   ...
   model pumpModel = IDEAS.Fluid.Movers.FlowMachine_y (
  ...
  IDEAS.Fluid.Sources.Boundary_pT sou1(
    ...
    T=293.15) annotation (Placement(transformation(extent={{-10,-10},{10,10}},
          rotation=180,
        origin={128,88})));
  IDEAS.Fluid.Actuators.Valves.TwoWayLinear dp1(
    redeclare package Medium = Medium,
  ...
  IDEAS.Fluid.Actuators.Valves.TwoWayLinear dp2(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dpValve_nominal=0.01*dp_nominal,
    filteredOpening=false) "Pressure drop"
  ...
  IDEAS.Fluid.Actuators.Valves.TwoWayLinear dp3(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dpValve_nominal=0.01*dp_nominal,
    filteredOpening=false) "Pressure drop"
  ...
  Modelica.Blocks.Sources.Constant
          ...
          rotation=0)));
  IDEAS.Fluid.Actuators.Valves.TwoWayLinear dp4(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal,
    dpValve_nominal=0.01*dp_nominal,
    filteredOpening=false) "Pressure drop"
...
__Dymola_Commands(file="modelica://IDEAS/Resources/Scripts/Dymola/Fluid/Movers/Examples/FlowMachine_y_pumpCurves.mos"
        "Simulate and plot"),
