...
model Example
  ...
  IDEAS.DistrictHeating1.Substations.HXWithBypass hXWithBypass
    annotation (Placement(transformation(extent={{-18,-26},{2,-6}})));
  IDEAS.DistrictHeating1.Production.Boiler boiler(boiler(dp_nominal=10000, QNom
  ...
  IDEAS.DistrictHeating1.Substations.HXWithBypass hXWithBypass1
